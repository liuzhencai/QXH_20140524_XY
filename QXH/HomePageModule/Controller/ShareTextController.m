    ...
    switch (indexPath.section) {
        ...
        case 1:
        {
            if (self.type == 3) {
                ...
                CGSize textSize = [NSString getStringRect:_info.refsign font:[UIFont systemFontOfSize:SQUARE_DETAIL_CONTENT_FONT] labelSize:CGSizeMake(SQUARE_DETAIL_CONTENT_WIDTH, FLT_MAX)];
                if (![tmpModel.sphoto isEqualToString:@""]) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (section) {
        ...
        case 1:
        {
            if (self.type == SquareInfoTypeInf||self.type == SquareInfoTypeTrans) {
