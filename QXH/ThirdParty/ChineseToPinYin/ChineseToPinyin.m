...
char mypinyinFirstLetter(unsigned short hanzi)
{
...
{
    NSString* pinyinStr = [self pinyinFromChiniseString:string];
    return [pinyinStr substringToIndex:1];
}
...
+ (char) sortSectionTitle:(NSString *)string
{
	...
	{	
		   ...
		   ([string characterAtIndex:0] > 96 &&  [string characterAtIndex:0] < 123 ) )
		{
			...
			cLetter = mypinyinFirstLetter((unsigned short)[string characterAtIndex:0] );
